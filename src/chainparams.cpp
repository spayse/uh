...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "GUY OFFICIAL FAIR LAUNCH";
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("209.18.47.62"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // GUY test net start with T
