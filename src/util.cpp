...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\MMR
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\MMR
    // Mac: ~/Library/Application Support/MMR
    // Unix: ~/.MMR
#ifdef WIN32
    // Windows
